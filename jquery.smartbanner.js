...
!function ($) {
    ...
    SmartBanner.prototype = {
      ...
      , create: function () {
          var iconURL
            , link = this.type == 'windows' ? 'ms-windows-store:PDP?PFN=' + this.pfn : (this.type == 'android' ? 'market://details?id=' : 'https://itunes.apple.com/' + this.options.appStoreLanguage + '/app/id') + this.appId
