...
!function ($) {
    var SmartBanner = function (options) {
        ...
        if (this.type == 'windows') this.appId = $('meta[name="msApplication-PackageFamilyName"]').attr('content');
        else {
            // Try to pull the appId out of the meta tag and store the result
            var parsedMetaContent = /app-id=([^\s,]+)/.exec(meta.attr('content'));

            if(parsedMetaContent) this.appId = parsedMetaContent[1];
            else return;
        }
    ...
    SmartBanner.prototype = {
        ...
        create: function() {
            ...
            if (this.options.icon) iconURL = this.options.icon;
            else if(this.iconUrl) iconURL = this.iconUrl;
            ...
            else if ($('meta[name="msapplication-TileImage"]').length > 0) iconURL = $('meta[name="msapplication-TileImage"]').attr('content'); /* redundant because ms docs show two case usages */
        ...
        hide: function(callback) {
            ...
            if (this.options.layer) {
                ...
                if ($.support.transition) {
                    if ( this.type !== 'android' ) banner.css('top', -1*this.bannerHeight*this.scale).removeClass('shown');
